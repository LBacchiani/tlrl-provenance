#!/usr/bin/env python
"""Launch the frozen DeepLTL LetterEnv PPO development pilot.

Mirrors scripts/launch_deepltl_point_ppo_pilot.py exactly.
"""
...
EVIDENCE = ROOT / "evidence" / "letter_env" / "ppo" / "development" / "training"
MANIFEST = EVIDENCE / "letter_env_ppo_5m_development_pilot_manifest.json"
LAUNCH_RECORD = EVIDENCE / "letter_env_ppo_5m_development_pilot_launch.json"
...
def main() -> None:
    ...
    record = {
        "schema_version": "tlrl-letter-env-ppo-development-pilot-launch/1",
        "status": "launched",
        "scope": manifest["scope"],
        "manifest_path": "evidence/letter_env/ppo/development/training/letter_env_ppo_5m_development_pilot_manifest.json",
