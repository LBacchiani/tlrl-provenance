#!/usr/bin/env python
"""Launch the frozen DeepLTL PointWorld PPO development pilot."""
...
EVIDENCE = ROOT / "evidence" / "deepltl_point" / "development" / "training"
MANIFEST = EVIDENCE / "deepltl_point_ppo_5m_development_pilot_manifest.json"
LAUNCH_RECORD = EVIDENCE / "deepltl_point_ppo_5m_development_pilot_launch.json"
...
def main() -> None:
    ...
    record = {
        "schema_version": "tlrl-deepltl-point-ppo-development-pilot-launch/1",
        "status": "launched",
        "scope": manifest["scope"],
        "manifest_path": "evidence/deepltl_point/development/training/deepltl_point_ppo_5m_development_pilot_manifest.json",
